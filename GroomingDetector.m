...
% -- pushbutton--'Preview'--Show a sample frame of loaded viodes
...
global TransVideo;
SliderVal=get(hObject,'Value');
Yinterval=floor(SliderVal*(Yend-Yinitial)/Nrow)+floor(Yend/20);
