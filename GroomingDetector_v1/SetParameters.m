...
% Last Modified by GUIDE v2.5 13-Jun-2017 00:54:47
...
set(handles.edit1,'string',num2str(TempParameters.FrameRate));
set(handles.edit2,'string',num2str(TempParameters.AnalyzingRate));
set(handles.edit3,'string',num2str(TempParameters.Nrow));
set(handles.edit4,'string',num2str(TempParameters.Ncolumn));
set(handles.checkbox1,'Value',TempParameters.TransVideo);
...
% handles    structure with handles and user data (see GUIDATA)
TempParameters=load('Parameters.mat');
TempParameters.FrameRate = str2double(get(handles.edit1,'String'));
TempParameters.AnalyzingRate = str2double(get(handles.edit2,'String'));
TempParameters.Nrow = str2double(get(handles.edit3,'String'));
TempParameters.Ncolumn = str2double(get(handles.edit4,'String'));
TempParameters.TransVideo = get(handles.checkbox1,'Value');
...
% handles    structure with handles and user data (see GUIDATA)
TempParameters=load('Parameters.mat');
TempParameters.FrameRate = 10;
TempParameters.AnalyzingRate = 5;
TempParameters.Nrow = 10;
TempParameters.Ncolumn = 2;
TempParameters.TransVideo = 0;
TempParameters.C0=10;
TempParameters.C1=25;
save Parameters.mat -struct TempParameters;
