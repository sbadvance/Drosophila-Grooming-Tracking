...
% Last Modified by GUIDE v2.5 13-Jun-2017 00:48:21
...
set(handles.edit1,'string',num2str(TempParameters.BackgroundRate));
set(handles.edit2,'string',num2str(TempParameters.KNeighbors));
set(handles.edit3,'string',num2str(TempParameters.NumberofContrast));
set(handles.edit4,'string',num2str(TempParameters.VideoBatchSize));
...
TempParameters=load('Parameters.mat');
TempParameters.BackgroundRate = str2double(get(handles.edit1,'String'));
TempParameters.KNeighbors = str2double(get(handles.edit2,'String'));
TempParameters.NumberofContrast = str2double(get(handles.edit3,'String'));
TempParameters.VideoBatchSize = str2double(get(handles.edit4,'String'));
...
global Ncolumn;
global TransVideo;
global BckgroundRate;
global KNeighbors;
global NumberofContrast;
global VideoBatchSize;
load('Parameters')

close(AdvancedSetting)
...
% handles    structure with handles and user data (see GUIDATA)
TempParameters=load('Parameters.mat');
TempParameters.BackgroundRate = 60;
TempParameters.KNeighbors = 10;
TempParameters.NumberofContrast = 8;
TempParameters.VideoBatchSize = 500;
